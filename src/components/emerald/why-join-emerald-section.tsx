...
export function WhyJoinEmeraldSection() {
  return (
    <section className="section-padding premium-section-alt">
      <div className="container-EBN">
        <SectionHeading
          ...
          subtitle="Discover how structured business networking can help you build relationships, generate referrals, and grow your business within Bangalore and across India."
        />
            ...
            return (
              <FadeIn key={item.title} delay={i * 0.08}>
                <GlassCard className="h-full">
                  ...
                  <h3 className="mb-3 font-heading text-xl font-bold text-EBN-navy">{item.title}</h3>
