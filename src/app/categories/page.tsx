...
export const metadata: Metadata = {
  ...
  description:
    "Explore 50+ business categories in the EBN network. Find professionals in construction, technology, healthcare, finance, and every industry that drives Indian business.",
};
        ...
        <div className="container-EBN relative z-10">
          <FadeIn>
            ...
            <p className="text-lg md:text-xl text-muted max-w-2xl leading-relaxed mb-8">
              EBN chapters represent professionals across 50+ industries. Find members
